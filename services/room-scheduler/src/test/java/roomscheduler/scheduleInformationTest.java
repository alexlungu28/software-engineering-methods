...
public class scheduleInformationTest {
    Timestamp start = new Timestamp(120, 9, 1, 12, 30, 0, 0);
    Timestamp start2 = new Timestamp(120, 9, 1, 12, 30, 0, 0);
    Timestamp end = new Timestamp(120, 11, 1, 12, 30, 0, 0);
    Timestamp end2 = new Timestamp(120, 11, 1, 12, 30, 0, 0);
    ...
    void equalsTest() {
        ...
        ScheduleInformation si5 = new ScheduleInformation(2, start, end, 1, 1, 100);
        assertEquals(si, si2);
    ...
    void toStringTest() {
        ScheduleInformation si = new ScheduleInformation(1, start, end, 1, 1, 50);
        assertEquals(si.toString(), "ScheduleInformation{roomScheduleId=1, startTime=2020-10-01 12:30:00.0, endTime=2020-12-01 12:30:00.0, lectureId=1, roomId=1, coronaCapacity=50}");
    }
