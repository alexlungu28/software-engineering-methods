...
/**
 * This is some basic code to let hibernate know we want a repository for the StudentEnrollments, and that we can retrieve
 * them. Specifically we can find an enrollment by providing the course ID and Student. Hibernates does the magic of
 * creating a query for it.
 */
@Repository
